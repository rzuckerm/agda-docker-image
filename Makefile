AGDA_VERSION := $(shell cat AGDA_VERSION)
AGDA_DEPS := $(wildcard AGDA_*)
DOCKER_TAG_PREFIX := rzuckerm/agda:$(AGDA_VERSION)
...
$(META_BUILD_TARGET): Dockerfile Makefile $(AGDA_DEPS)
